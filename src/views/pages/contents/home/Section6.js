          ...
          <Row key={faq.id} className="d-flex align-items-center mb-3">
            <Col md="5">
              <FormGroup className={`has-label ${faq.questionState} mb-0`}>
                ...
                />
                {faq.questionState === "has-danger" && (
                  <Label className="error">Question cannot be empty.</Label>
                )}
              </FormGroup>
            </Col>
            <Col md="4">
              <FormGroup className={`has-label ${faq.answerState} mb-0`}>
                ...
                />
                {faq.answerState === "has-danger" && (
                  <Label className="error">Answer cannot be empty.</Label>
                )}
              </FormGroup>
            </Col>
