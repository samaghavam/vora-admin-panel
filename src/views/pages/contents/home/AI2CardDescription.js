...
const AI2CardDescription = forwardRef((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    getData: () => ({
        ai2Name: aiName, 
        ai2Description: aiDescription,
        ai2CardBg: aiCardBg,
        ai2Point1Title: point1Title, 
        ai2Point1Desc: point1Desc, 
        ai2Point1Icon: point1Icon,
        ai2Point2Title: point2Title, 
        ai2Point2Desc: point2Desc, 
        ai2Point2Icon: point2Icon,
        ai2Point3Title: point3Title, 
        ai2Point3Desc: point3Desc, 
        ai2Point3Icon: point3Icon,
    }),
  }));
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle tag="h5">AI 2 - Card description</CardTitle>
      </CardHeader>
      <CardBody>
        <Row>
          <Col md="8">
            <FormGroup className={`has-label ${aiNameState}`}>
              <Label>AI 2 Name</Label>
...
export default AI2CardDescription;
